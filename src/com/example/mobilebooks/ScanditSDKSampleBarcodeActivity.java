 ...
 * the License.
 */
public class ScanditSDKSampleBarcodeActivity extends Activity implements
		ScanditSDKListener {

	// The main object for recognizing a displaying barcodes.
	private ScanditSDK mBarcodePicker;
	private Button mButton;
	public String cleanedBarcode = "";
	// Enter your Scandit SDK App key here.
	// Your Scandit SDK App key is available via your Scandit SDK web account.
	public static final String sScanditSdkAppKey = "weLIUq5DEeOQnDet8EzG072SzkZ5IPrBEAdc7vY4L+8";
	...
	public void didScanBarcode(String barcode, String symbology) {
		...
		mButton.setText("Scanned " + symbology + " code:\n\n" + cleanedBarcode
				+ "\n\n\n\nTap to continue");
		((RelativeLayout) mBarcodePicker).addView(mButton,
		...
		mButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// Uri uri = Uri.parse("content://isbn/" + cleanedBarcode);
				intent.putExtra("RESULT_STRING", cleanedBarcode);
